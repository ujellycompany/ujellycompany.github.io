<?php
// database/xx_pages.php fields - where xx is en
...
// database/xx_pages_files.php fields - where xx is en
$aPagesFilesFields = Array( 'iFile', 'iPage', 'sFileName', 'iPhoto', 'iPosition', 'iType', 'iSize1', 'iSize2', 'sDescription' );

// database/xx_products.php fields - where xx is en
...
// database/xx_products_files.php fields - where xx is en
$aProductsFilesFields = Array( 'iFile', 'iProduct', 'sFileName', 'iPhoto', 'iPosition', 'iType', 'iSize1', 'iSize2', 'sDescription' );

// database/xx_payments_shipping.php fields - where xx is en
