...
*/
$config['login'] = "ujellycompany";
$config['pass'] = "veelstejelly123";
...
$config['change_files_names'] = true;
...
$config['display_thumbnail_2'] = true; // thumbnail 2 visibility
...
$config['last_login'] = "1516989493";
$config['before_last_login'] = "1516971072";
