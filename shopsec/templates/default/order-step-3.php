...
if( isset( $aData['sName'] ) ){ // displaying pages and subpages content
  ...
  if( $oOrder->checkEmptyBasket( ) === false && isset( $_POST['sOrderSend'] ) && $oOrder->checkFields( $_POST ) === true ){
    ...
    <h2>Bedankt voor uw bestelling!<br>
    Selecteer aub een betaalmethode:</h2>
    <br>
    <br>
    <br>


    <img class="payments" src="http://www.demacmedia.com/wp-content/uploads/2014/04/Payment-Gateway.jpg"></img>
    ...
    <h3>We zien u graag terug bij UJelly!</h3>
