  ...
  */
  public function listLastOrders( ){
    ...
    if( isset( $aOrders ) ){
      ...
      unset( $this->aOrders );
      return '<table cellspacing="0"><thead><tr><td>'.$GLOBALS['lang']['Id'].'</td><td>'.$GLOBALS['lang']['Name'].'</td><td>'.$GLOBALS['lang']['Date'].'</td></tr></thead>'.$content.'</tbody></table>';
    }
  ...
  public function listProductsAdmin( $iOrder ){
    ...
    if( isset( $this->aProducts ) ){
      ...
      foreach( $this->aProducts as $aData ){
        $content .= '<tr><td class="id"><a href="?p=products-form&amp;iProduct='.$aData['iProduct'].'&amp;sLang='.$GLOBALS['sOrderLang'].'" target="_blank">'.$aData['iProduct'].'</a></td><td class="name"><input type="text" name="aProducts['.$aData['iElement'].'][sName]" value="'.$aData['sName'].'" class="input" size="40" alt="simple" /></td><td class="price"><input type="text" name="aProducts['.$aData['iElement'].'][fPrice]" value="'.displayPrice( $aData['fPrice'] ).'" class="inputr" size="7" maxlength="15" alt="float" /></td><td class="quantity"><input type="text" name="aProducts['.$aData['iElement'].'][iQuantity]" value="'.$aData['iQuantity'].'" class="input" size="2" maxlength="3" alt="int" /></td><td class="summary">'.displayPrice( normalizePrice( $aData['fSummary'] ) ).'</td><td class="options"><input type="checkbox" name="aProductsDelete['.$aData['iElement'].']" value="1" /></td></tr>';
        $i++;
      }
