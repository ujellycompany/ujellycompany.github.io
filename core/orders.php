...
class Orders
{
  ...
  */
  public function sendEmailWithOrderDetails( $iOrder ){
    ...
    $sMailContent = str_replace( '|n|', "\n", $lang['Order_customer_email_head']."<html><head><STYLE TYPE=text/css>
<!--
TD{font-family: Arial; font-size: 13pt; background-color: white; text-align: left;}
H1{{font-family: Arial; font-size: 19pt;}
H6{max-height: 0; display:none;}
--->
</STYLE>
</head><body><table width=700 border=0><tr><td colspan=4><b><h2>".$lang['Order_customer_personal']."</b></h2></td></tr><tr><td width=250>"."<b>Voornaam: </b></td><td width=250>".$aData['sFirstName']."</td><td width=100></td><td width=100></td></tr><tr><td><b>Achternaam: </b></td><td>".' '.$aData['sLastName']."</td><td></td><td></td></tr><tr><td><b>bedrijf: </b></td><td>".( isset( $aData['sCompanyName'] ) ? "\n".$aData['sCompanyName'] : null )."</td><td></td></tr><tr><td><b>Straat</b></td><td3>".$aData['sStreet']."</td><td></td><td></td></tr><tr><td><b>Postcode: </b></td><td>".$aData['sZipCode']."</td><td></td><td></td></tr><tr><td><b>Stad</b></td><td>".$aData['sCity']."</td><td></td><td></td></tr><tr><td><b>Telefoon: </b></td><td>".$aData['sPhone']."</td><td></td><td></td></tr><tr><td><b>Email: </b></td><td>".$aData['sEmail']."</td><td></td><td></td></tr>
...
<tr><td style=text-decoration: none;>".$this->listProducts(  true  )."</td></tr>

<!--verbo rgen, moet niet getoond worden-->
<!--<tr><td colspan=4>".$this->listProducts( $iOrder, true  )."</td></tr>-->



<!--2 header-->
<tr><td colspan=4><h2>".( isset( $aData['iShipping'] ) ."</td><td>"? $lang['Order_customer_shipping']."</h2></td></tr>

<!--3 -->
<tr><td>".$aData['mShipping'].' ('.$aData['mPayment'].')</td><td></td><td></td><td>'.$this->aOrders[$iOrder]['sPaymentShippingPrice'].' '.$config['currency_symbol']. "": null )."</td></tr>

<!--4 de bestelde artikelen-->
<tr><td>".$lang['Summary_cost']."</td><td></td><td></td><td>".$this->aOrders[$iOrder]['sOrderSummary'].' '.$config['currency_symbol'].$lang['Order_customer_email_foot'] )."</td></tr>
