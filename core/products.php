  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $('.sort').click(function() {
        $('.sortli').toggleClass('activesortli');
    ...
    if( isset( $sSortingLink ) ){
      ...
      foreach( $aSorts as $sLink => $sName ){
        if( ( $sLink == 'default' && !isset( $sSort ) ) || ( isset( $sSort ) && $sSort == $sLink ) )
          $sLinks .= '<li class="sortli">'.$sName.'</li>';
        elseif( $sLink == 'default' && isset( $sSort ) ){
          $sLinks .= '<a href="'.$sSortingLink.'"><li class="sortli">'.$sName.'</li></a>';
        }
        else{
          $sLinks .= '<a href="'.$sSortingLink.'&amp;sSort='.$sLink.'"><li class="sortli">'.$sName.'</li></a>';
        }
      } // end foreach
      return '<div class="sort"><div class="sortarrowdown"></div><ul class="sortul"><p class="sorttext">'.$lang['Sort_by'].'</p><div class="sortlists">'.$sLinks.'</div></ul></div>';
    }
    else{
      return $aSorts;
    }
